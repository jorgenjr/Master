...
# np_gene_dictionary_clean = mixtures.from_matrix_to_dictionary(norm_matrix_combined, np_gene_dictionary_clean);

# file_handler.write_to_file(np_gene_dictionary_clean, "_clean")
