...
# write.table(A$coefficients, file=args[8], sep="\t")
# write.table(B$coefficients, file=args[8], sep="\t", append=TRUE, col.names=TRUE)
# write.table(C$coefficients, file=args[8], sep="\t", append=TRUE, col.names=TRUE)
# write.table(D$coefficients, file=args[8], sep="\t", append=TRUE, col.names=TRUE)
